    ...
    <div class="contenedor">
        <div class="tarjetaPrin container shadow-lg">
            <div class=" row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3">
                ...
                <form  action="include/e19.inc.php" method="post">
                <div class="cont">
                    <div class="barra">
                      <p>Progreso</p>
                      <div class="progress">
                          <div class="progress-bar loco" style="width: 85%;">85%</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="tipBen" id="inp" placeholder="Tipo..."  >
                </div>
                </div>
                <div class="pregunta">
                    <div class="pre"><p>Beneficiario (Declarante, otro)  :</p></div>
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="benef" id="inp" placeholder="Beneficiario..."  >
                </div>
                </div>
                <div class="pregunta">
                    <div class="pre"><p>Otorgante :</p></div>
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="oto" id="inp" placeholder="Otorgante..."  >
                </div>
                </div>
                <div class="pregunta">
                ...
                <div class="pregunta">
                  ...
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="formRece" id="inp" placeholder="Forma de recepción..."  >
                </div>
                </div>
                <div class="pregunta">
                    <div class="pre"><p>Especifique el beneficio :</p></div>
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="espBen" id="inp" placeholder="Beneficiario..."  >
                </div>
                </div>
                <div class="pregunta">
