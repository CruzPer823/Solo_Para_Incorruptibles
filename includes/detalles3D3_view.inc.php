       ...
       <div class="contenedor3 shadow-lg">
         <div class="info">
           ...
           <h3>Ingresos actuales:</h3>
             <p><a href="e4.php?id='.$fila["id_3d3"].'">Ver información</a></p>
           </div>
           <div class="categoria">
           <h3>Currículo:</h3>
             <p><a href="e3.php?id='.$fila["id_3d3"].'">Ver información</a></p>
           </div>
           <div class="categoria">
           <h3>¿Ha tenido algun cargo Público?</h3>
             <p><a href="e5.php?id='.$fila["id_3d3"].'">Ver información</a></p>
           </div>
           <div class="categoria">
           <h3>Experiencia Laboral:</h3>
             <p><a href="e7.php?id='.$fila["id_3d3"].'">Ver información</a></p>
           </div>
           <div class="categoria">
           <h3>Bienes Inmuebles:</h3>
             <p><a href="e8.php?id='.$fila["id_3d3"].'">Ver información</a></p>
           </div>
         </div>
