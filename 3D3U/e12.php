    ...
    <div class="contenedor">
        <div class="tarjetaPrin container shadow-lg">
            ...
            <?php check_form_errors(); ?>
                <form  action="include/e12.inc.php" method="post">
                <div class="cont">
                    <div class="barra">
                      <p>Progreso</p>
                      <div class="progress">
                          <div class="progress-bar loco" style="width: 50%;">50%</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="tipAde" id="inp" placeholder="Tipo..."     >
                </div>
                </div>
                <div class="pregunta">
                  <div class="pre"><p>Fecha de adquisición del adeudo/pasivo :</p></div>
                <div class="inpSesion">
                  <input type="date" class="form-control" name="adqAde" id="inp" placeholder="dd/mm/yyyy"     >
              </div>
              </div>
                <div class="pregunta">
                ...
                <div class="pregunta">
                  ...
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="tipMon" id="inp" placeholder="Tipo..."     >
                </div>
                </div>
                <div class="pregunta">
                    <div class="pre"><p>¿Tiene codeudor?</p></div>
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="tieCod" id="inp" placeholder="Codeudor..."     >
                </div>
                </div>
                <div class="pregunta">
                    <div class="pre"><p>Tercero</p></div>
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="ter" id="inp" placeholder="Tercero..."     >
                </div>
                </div>
                <div class="pregunta">
                ...
                <div class="pregunta">
                  ...
                  <div class="inpSesion">
                    <input type="text" class="form-control" name="otoCre" id="inp" placeholder="Otorgante..."     >
                </div>
                </div>
                <div class="pregunta">
                  <div class="pre"><p>¿Dónde se localiza el adeudo? (méxico o el extranjero)</p></div>
                <div class="inpSesion">
                  <input type="text" class="form-control" name="ubiAde" id="inp" placeholder="Ubicación..."     >
              </div>
              </div>
                </div>
