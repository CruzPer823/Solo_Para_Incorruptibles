    ...
    <div class="contenedor">
        <div class="tarjetaPrin container shadow-lg">
            <div class=" row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3">
                ...
                <div class="cont">
                  ...
                  <div class="seccion"><p>Datos generales</p></div>
                    <div class="pregunta">
                      ...
                      <div class="inp"></div>
                      <div class="inpSesion">
                        <input type="text" class="form-control" name="nombre" id="inp" placeholder="Nombre..." required>
                    </div>
                    </div>
                    <div class="pregunta">
                    ...
                    <div class="inp"></div>
                    <div class="inpSesion">
                      <input type="text" class="form-control" name="partido" id="inp" placeholder="Partido o coalición..." required>
                  </div>
                  </div>
                  <div class="pregunta">
                ...
                <div class="inp"></div>
                <div class="inpSesion">
                  <input type="file" class="form-control" name="foto" id="inp" required>
              </div>
              </div>
                </div>
