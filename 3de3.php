...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="nv collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="3de3.html">Iniciativa 3 de 3</a>
            </li>
            <li class="nav-item">
    ...
    <div class="contenedor">
        <img class="I3" src="assets/3d3.png" alt=" Tres de tres">
        <div class="cont"><p>Visita el perfil de las candidaturas!</p></div>
    </div>
    <!-- Tabla de candidatos -->
   <div class="contenedord">
    <div class="table-responsive">
        <table class="table table-hover table-bordered border-black tabla">
            <thead>
                <tr>
